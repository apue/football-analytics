...
def load_academy_study_config(
    ...
    return AcademyStudyConfig(
        ...
        roster_source_adapter=roster_source["adapter"],
        ...
        adult_source_adapter=adult_source["adapter"],
...
def _source(value: Any, name: str, *, require_approved: bool) -> dict[str, str]:
    ...
    adapter = _text(source.get("adapter"), f"{name}.adapter")
